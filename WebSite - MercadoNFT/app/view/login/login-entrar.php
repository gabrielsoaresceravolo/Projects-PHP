            ...
            <div class="container relative">
                <div class="flex justify-center">
                    <div class="max-w-[400px] w-full m-auto p-6 bg-white dark:bg-slate-900 shadow-md dark:shadow-gray-800 rounded-md">
                        ...
                        <h5 class="my-6 text-xl font-semibold">Entrar na conta</h5>
                        <form class="text-start" action="../../controllers/LoginController.php" method="post">
                            <div class="grid grid-cols-1">
                                ...
                                <div class="flex justify-between mb-4">
                                    <div class="flex items-center mb-0">
                                        ...
                                        <label class="form-checkbox-label text-slate-400" for="RememberMe">Lembre de mim</label>
                                    </div>
                                    <p class="text-slate-400 mb-0"><a href="login-recuperar.html" class="text-indigo-600">Esqueceu a senha ?</a></p>
                                </div>

                                <div class="mb-4">
                                    <input type="submit" name="loginUsuario" class="py-2 px-5 inline-block tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md w-full" value="Entrar">
                                </div>

                                <div class="text-center">
                                    <span class="text-slate-400 me-2">Ainda não tem uma conta ?</span> <a href="login-criar.html" class="text-black dark:text-white font-bold inline-block">Criar conta</a>
                                </div>
                            </div>
                        </form>
                    </div>
